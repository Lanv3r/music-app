...
import cover3 from "../assets/covers/tdd-gde-ti.jpeg";
import cover4 from "../assets/covers/Куок - Мои роботы.jpeg";
...
const songs = [
  ...
  { id: 3, title: "Три дня дождя - Где ты", cover: cover3, file: song3 },
  { id: 4, title: "Куок - Мои роботы", cover: cover4, file: song4 },
];
